...
type Stock struct {
	...
	Hsl       float64   `gorm:"type:numeric(16,4);comment:换手率(%)" json:"hsl"`
	Zf        float64   `gorm:"type:numeric(16,4);comment:振幅(%)" json:"zf"`
	...
	Speed     float64   `gorm:"type:numeric(16,4);comment:涨速(%)" json:"speed"`
	...
	ZdfD5     float64   `gorm:"type:numeric(16,4);comment:5日涨跌幅(%)" json:"zdf_d5"`
	ZdfD10    float64   `gorm:"type:numeric(16,4);comment:10日涨跌幅(%)" json:"zdf_d10"`
	ZdfD20    float64   `gorm:"type:numeric(16,4);comment:20日涨跌幅(%)" json:"zdf_d20"`
	ZdfD60    float64   `gorm:"type:numeric(16,4);comment:60日涨跌幅(%)" json:"zdf_d60"`
	ZdfW52    float64   `gorm:"type:numeric(16,4);comment:52周涨跌幅(%)" json:"zdf_w52"`
	ZdfY      float64   `gorm:"type:numeric(16,4);comment:今年以来涨跌幅(%)" json:"zdf_y"`
	Ljjz      float64   `gorm:"type:numeric(16,4);comment:累计净值" json:"ljjz"`
